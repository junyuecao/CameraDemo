...
class TextureRender {
    ...
    public void calculateVertexBuffer(int displayW, int displayH, int imageW, int imageH) {
        ...
        float[] cube = new float[]{
                TextureRotationUtil.CUBE[0] / ratioHeight, TextureRotationUtil.CUBE[1] / ratioWidth, 0f,
                TextureRotationUtil.CUBE[2] / ratioHeight, TextureRotationUtil.CUBE[3] / ratioWidth, 0f,
                TextureRotationUtil.CUBE[4] / ratioHeight, TextureRotationUtil.CUBE[5] / ratioWidth, 0f,
                TextureRotationUtil.CUBE[6] / ratioHeight, TextureRotationUtil.CUBE[7] / ratioWidth, 0f
        };
    ...
    //  */
    // public void saveFrame(String filename, int width, int height, ImageSaveHandler handler) {
    //     ImageSaveModel imageSaveModel = new ImageSaveModel();
    //     imageSaveModel.file = new File(filename);
    //     imageSaveModel.rgbaBuffer = ByteBuffer.allocate(width * height * 4);
    //     imageSaveModel.rgbaBuffer.order(ByteOrder.LITTLE_ENDIAN);
    //     imageSaveModel.rgbaBuffer.rewind();
    //     GLES20.glReadPixels(0, 0, width, height,
    //             GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE,  imageSaveModel.rgbaBuffer);
    //     Message msg = handler.obtainMessage(0, imageSaveModel);
    //     msg.arg1 = width;
    //     msg.arg2 = height;
